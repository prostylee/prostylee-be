...
/**
 * This specification defines a set of standard Claims following Open Id standard claims
 *
...
public class OAuthUserInfoRequest {
    ...
    /**
     * Middle name(s) of the End-User. Note that in some cultures, people can have multiple middle names; all can be present, with the names being separated by space characters.
    ...
    /**
     * from zoneinfo [zoneinfo] time zone database representing the End-User's time zone.
