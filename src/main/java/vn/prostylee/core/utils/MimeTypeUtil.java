...
public class MimeTypeUtil {
	 ...
	 */
	private static final Map<String, Object> MIME_TYPES;
	...
	public static String getMimeType(String extension) {
		...
		if (extension.contains(".")) {
			extensionWithoutDot = FilenameUtils.getExtension(extension);
		}

		// get value for particular key
		Object strMimeType = MIME_TYPES.get(extensionWithoutDot);
		if (strMimeType != null) {
			return StringUtils.defaultIfBlank(strMimeType.toString(), DEFAULT_MIME_TYPE);
		}
		return DEFAULT_MIME_TYPE;
	}
}
